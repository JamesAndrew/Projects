...
public class KnowledgeBaseTest {
    ...
    public void test_KB_axioms_safe_centered()
    {
        ...
        KBAtom safePercept0 = new KBAtomConstant(false, "EXPLORED",  World.getRoom(0, 1)); 
        KBAtom safePercept1 = new KBAtomConstant(true,  "SMELLY",    World.getRoom(0, 1)); 
        KBAtom safePercept2 = new KBAtomConstant(true,  "WINDY",     World.getRoom(0, 1)); 
        // is smell from right cell
        KBAtom safePercept3 = new KBAtomConstant(false, "EXPLORED",  World.getRoom(1, 0)); 
        KBAtom safePercept4 = new KBAtomConstant(true,  "SMELLY",    World.getRoom(1, 0)); 
        KBAtom safePercept5 = new KBAtomConstant(false, "WINDY",     World.getRoom(1, 0)); 
        ...
        KBAtomConstant queryAtom1 = new KBAtomConstant(true, "SAFE", World.getRoom(1, 1)); // is room (1,1) safe
    ...
    public void test_KB_axioms_safe_leftWall()
    {
        ...
        KBAtom safePercept0 = new KBAtomConstant(false, "EXPLORED", World.getRoom(0, 2)); 
        KBAtom safePercept1 = new KBAtomConstant(true,  "SMELLY",   World.getRoom(0, 2)); 
        KBAtom safePercept2 = new KBAtomConstant(true,  "WINDY",    World.getRoom(0, 2)); 
        // is smell from other adjacent cell
        KBAtom safePercept3 = new KBAtomConstant(false, "EXPLORED", World.getRoom(1, 1)); 
        KBAtom safePercept4 = new KBAtomConstant(true,  "SMELLY",   World.getRoom(1, 1)); 
        KBAtom safePercept5 = new KBAtomConstant(false, "WINDY",    World.getRoom(1, 1)); 
        ...
        KBAtomConstant queryAtom1 = new KBAtomConstant(false, "SAFE", World.getRoom(0, 1)); // is room (0,1) safe
        System.out.println("query: " + queryAtom1.toString());
        boolean expectedOutput1 = true;
        boolean actualOutput1 = kb.query(queryAtom1);   
        System.out.format("query result: %b%n%n", actualOutput1);
    ...
    public void test_KB_axioms_safe_topLeftCorner()
    {
        ...
        KBAtom safePercept2 = new KBAtomConstant(true,  "WINDY",     World.getRoom(0, 1)); 
        // is smell from other adjacent cell
        KBAtom safePercept3 = new KBAtomConstant(false, "EXPLORED", World.getRoom(1, 2)); 
        KBAtom safePercept4 = new KBAtomConstant(true,  "SMELLY",   World.getRoom(1, 2)); 
        KBAtom safePercept5 = new KBAtomConstant(false, "WINDY",    World.getRoom(1, 2)); 
        ...
        KBAtomConstant queryAtom1 = new KBAtomConstant(false, "SAFE", World.getRoom(0, 2)); // is room (0,1) safe
        System.out.println("query: " + queryAtom1.toString());
        boolean expectedOutput1 = true;
        boolean actualOutput1 = kb.query(queryAtom1);   
        System.out.format("query result: %b%n%n", actualOutput1);
    ...
    public void test_KB_axioms_safe_topWall()
    {
        ...
        KBAtom safePercept0 = new KBAtomConstant(false, "EXPLORED", World.getRoom(1, 1)); 
        KBAtom safePercept1 = new KBAtomConstant(true,  "SMELLY",   World.getRoom(1, 1)); 
        KBAtom safePercept2 = new KBAtomConstant(true,  "WINDY",    World.getRoom(1, 1)); 
        // is smell from other adjacent cell
        KBAtom safePercept3 = new KBAtomConstant(false, "EXPLORED", World.getRoom(0, 2)); 
        KBAtom safePercept4 = new KBAtomConstant(true,  "SMELLY",   World.getRoom(0, 2)); 
        KBAtom safePercept5 = new KBAtomConstant(false, "WINDY",    World.getRoom(0, 2)); 
        ...
        KBAtomConstant queryAtom1 = new KBAtomConstant(false, "SAFE", World.getRoom(1, 2)); // is room safe?
        System.out.println("query: " + queryAtom1.toString());
        boolean expectedOutput1 = true;
        boolean actualOutput1 = kb.query(queryAtom1);   
        System.out.format("query result: %b%n%n", actualOutput1);
    ...
    public void test_KB_axioms_safe_topRightCorner()
    {
        ...
        KBAtom safePercept0 = new KBAtomConstant(false, "EXPLORED", World.getRoom(1, 2)); 
        KBAtom safePercept1 = new KBAtomConstant(true,  "SMELLY",   World.getRoom(1, 2)); 
        KBAtom safePercept2 = new KBAtomConstant(true,  "WINDY",    World.getRoom(1, 2)); 
        // is smell from other adjacent cell
        KBAtom safePercept3 = new KBAtomConstant(false, "EXPLORED", World.getRoom(2, 1)); 
        KBAtom safePercept4 = new KBAtomConstant(true,  "SMELLY",   World.getRoom(2, 1)); 
        KBAtom safePercept5 = new KBAtomConstant(false, "WINDY",    World.getRoom(2, 1)); 
        ...
        KBAtomConstant queryAtom1 = new KBAtomConstant(false, "SAFE", World.getRoom(2, 2)); // is room safe?
        System.out.println("query: " + queryAtom1.toString());
        boolean expectedOutput1 = true;
        boolean actualOutput1 = kb.query(queryAtom1);   
        System.out.format("query result: %b%n%n", actualOutput1);
    ...
    public void test_KB_axioms_safe_rightWall()
    {
        ...
        KBAtom safePercept2 = new KBAtomConstant(true,  "WINDY",    World.getRoom(1, 1)); 
        // is smell from other adjacent cell
        KBAtom safePercept3 = new KBAtomConstant(false, "EXPLORED", World.getRoom(2, 0)); 
        KBAtom safePercept4 = new KBAtomConstant(true,  "SMELLY",   World.getRoom(2, 0)); 
        KBAtom safePercept5 = new KBAtomConstant(false, "WINDY",    World.getRoom(2, 0)); 
        ...
        KBAtomConstant queryAtom1 = new KBAtomConstant(false, "SAFE", World.getRoom(2, 1)); // is room safe?
        System.out.println("query: " + queryAtom1.toString());
        boolean expectedOutput1 = true;
        boolean actualOutput1 = kb.query(queryAtom1);   
        System.out.format("query result: %b%n%n", actualOutput1);
    ...
    public void test_KB_axioms_safe_bottomWall()
    {
        ...
        KBAtom safePercept0 = new KBAtomConstant(false, "EXPLORED", World.getRoom(0, 0)); 
        KBAtom safePercept1 = new KBAtomConstant(true,  "SMELLY",   World.getRoom(0, 0)); 
        KBAtom safePercept2 = new KBAtomConstant(true,  "WINDY",    World.getRoom(0, 0)); 
        // is smell from other adjacent cell
        KBAtom safePercept3 = new KBAtomConstant(false, "EXPLORED", World.getRoom(1, 1)); 
        KBAtom safePercept4 = new KBAtomConstant(true,  "SMELLY",   World.getRoom(1, 1)); 
        KBAtom safePercept5 = new KBAtomConstant(false, "WINDY",    World.getRoom(1, 1)); 
        ...
        KBAtomConstant queryAtom1 = new KBAtomConstant(false, "SAFE", World.getRoom(1, 0)); // is room safe?
        System.out.println("query: " + queryAtom1.toString());
        boolean expectedOutput1 = true;
        boolean actualOutput1 = kb.query(queryAtom1);   
        System.out.format("query result: %b%n%n", actualOutput1);
    ...
    public void test_KB_axioms_safe_bottomLeftCorner()
    {
        ...
        KBAtomConstant queryAtom1 = new KBAtomConstant(false, "SAFE", World.getRoom(0, 0)); // is room safe?
        System.out.println("query: " + queryAtom1.toString());
        boolean expectedOutput1 = true;
        boolean actualOutput1 = kb.query(queryAtom1);   
        System.out.format("query result: %b%n%n", actualOutput1);
    ...
    public void test_KB_axioms_not_safe()
    {
        ...
        KBAtom safePercept0 = new KBAtomConstant(false, "EXPLORED", World.getRoom(1, 0)); 
        KBAtom safePercept1 = new KBAtomConstant(true,  "SMELLY",   World.getRoom(1, 0)); 
        KBAtom safePercept2 = new KBAtomConstant(false, "WINDY",    World.getRoom(1, 0)); 
        
        kb.update(safePercept0);
        kb.update(safePercept1);
        kb.update(safePercept2);
        
        KBAtomConstant queryAtom1 = new KBAtomConstant(false, "SAFE", World.getRoom(1, 1)); // is room safe?
        System.out.println("query: " + queryAtom1.toString());
        ...
        assertEquals(expectedOutput1, actualOutput1);
         ...
         KBAtomConstant queryAtom2 = new KBAtomConstant(false, "SAFE", World.getRoom(2, 2)); // is room safe?
    ...
    public void test_KB_axioms_resolveWumpus_noWumpus()
    {
        ...
        KBAtom smellyPercept1 = new KBAtomConstant(true, "SMELLY", World.getRoom(0, 1)); 
        
        kb.update(smellyPercept1);
        
        // wumpus in (1,1) if we know (0,1) isn't smelly?
        KBAtomConstant queryAtom1 = new KBAtomConstant(false, "WUMPUS", World.getRoom(1, 1)); 
        System.out.println("query: " + queryAtom1.toString());
        boolean expectedOutput1 = false;
        boolean actualOutput1 = kb.query(queryAtom1);   
        System.out.format("query result: %b%n%n", actualOutput1);
        ...
        KBAtomConstant queryAtom2 = new KBAtomConstant(false, "WUMPUS", World.getRoom(2, 2)); 
        System.out.println("query: " + queryAtom2.toString());
        boolean expectedOutput2 = false;
        boolean actualOutput2 = kb.query(queryAtom2);   
        System.out.format("query result: %b%n%n", actualOutput2);
